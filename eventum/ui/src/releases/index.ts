...
export const RELEASES: Release[] = [
  {
    ...
    highlights: [
      {
        id: 'opening',
        title: 'What this release brought',
        body: 'Ready-made generators, project export and import, and what each instance costs.',
        scene: OpeningScene,
      },
      {
        id: 'repositories',
        title: 'Install a ready-made generator',
        body: 'Connect a git repository and install a generator from its catalog.',
      ...
      },
      {
        ...
        body: 'Search GitHub for the repositories carrying the eventum-generators topic.',
        scene: DiscoverScene,
      ...
      },
      {
        ...
        body: 'Export a project as a ZIP archive and import it on another instance.',
        scene: ProjectArchiveScene,
        docsHref: `${DOCS}/studio/projects#moving-a-project-between-instances`,
      },
      {
        id: 'keyring-picker',
        title: 'Pick a secret from the keyring',
        body: 'Every password field offers the secrets the keyring holds.',
      ...
      },
      {
        ...
        body: 'A script reads and writes the same keys a template does.',
        scene: GlobalStateScene,
        docsHref: `${DOCS}/plugins/event/script`,
      },
      {
        id: 'monitoring',
        title: 'Monitoring is built around the instances',
        body: 'The chart and the table share one search and one selection.',
        scene: MonitoringScene,
        docsHref: `${DOCS}/studio/monitoring`,
      },
      {
        id: 'instance-resources',
        title: 'Every instance reports what it occupies',
        body: 'Processor, threads, disk, network and queue memory, per instance.',
        scene: InstanceResourcesScene,
        docsHref: `${DOCS}/studio/monitoring#instances`,
      },
      {
        id: 'log-channels',
        title: 'Every component writes its own log',
        body: 'Server, access, MCP and each generator get a file of their own.',
        scene: LogChannelsScene,
        docsHref: `${DOCS}/studio/settings#management`,
      },
      {
        id: 'queue-bytes',
        title: 'The events queue is capped in memory',
        body: 'It holds at most 256 MiB by default, and that limit can be changed.',
